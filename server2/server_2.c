...
const char *const INTERFACE_NAME = "in.softprayog.dbus_example2";
const char *const SERVER_BUS_NAME = "in.softprayog.server_2";
const char *const OBJECT_PATH_NAME = "/in/softprayog/adder";
const char *const METHOD_NAME = "mul_numbers";
//========================================================
const char *const METHOD_NAME_2 = "div_numbers";
...
//Gets arguments from a message given a variable argument list.
         ...
         // returns a pointer to the first token found in the string.  
                ...
                if (!error) {
                    ...
                    sprintf (answer, "Result is %ld", i * j);
        ...
        if (dbus_message_is_method_call (message, INTERFACE_NAME, METHOD_NAME_2)) {
            char *s;
            char *str1 = NULL, *str2 = NULL;
            const char space [4] = " \n\t";
            long i, j;
