...
const char *const CLIENT_BUS_NAME = "in.softprayog.sub_client";
const char *const SERVER_OBJECT_PATH_NAME = "/in/softprayog/adder";
const char *const CLIENT_OBJECT_PATH_NAME = "/in/softprayog/sub_client";
const char *const METHOD_NAME = "div_numbers";
